...
-   เพิ่มปุ่มที่จะ redirect จากหน้าหลักไปหน้าลงทะเบียน
-   Header สามารถคลิกเพื่อกลับไปหน้าหลักได้
-   ในกรณีที่ username/name+surname ยาวเกินไป จะใส่ ellipsis ต่อท้าย โดยสามารถเอาเมาส์ไป hover เพื่อดูชื่อแบบเต็มได้
